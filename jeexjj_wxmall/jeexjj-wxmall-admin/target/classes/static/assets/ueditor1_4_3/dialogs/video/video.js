...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        var acceptExtensions = (editor.getOpt('videoAllowFiles') || []).join('').replace(/^[,]/, '');;
        var suffix = conUrl.substring(conUrl.lastIndexOf(".")).toLowerCase();
        if(acceptExtensions.indexOf(suffix) > -1){
        	$G("preview").innerHTML = '<div class="previewMsg"><span><video controls="controls" ' +
        	' src="' + conUrl + '"' +
        	' width="420" height="280" ></video>'+'</span></div>';
        }else{
