...
<script type="text/javascript">
		$(function() {
		    //背景更换
		    $.backstretch([
		                    "${base}/style/passport/assets/img/bg/wx2.jpg"
			              , "${base}/style/passport/assets/img/bg/wx4.jpg"
			              , "${base}/style/passport/assets/img/bg/wx5.jpg"
			              , "${base}/style/passport/assets/img/bg/wx7.jpg"
			              , "${base}/style/passport/assets/img/bg/wx9.jpg"
			             ], {
			             	duration: 5000,
