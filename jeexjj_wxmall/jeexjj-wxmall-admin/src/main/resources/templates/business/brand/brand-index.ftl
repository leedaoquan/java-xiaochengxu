...
<@content id=tabId>
	...
	<@button type="info" icon="glyphicon glyphicon-plus" onclick="XJJ.add('${base}/business/brand/input','添加品牌','${tabId}');">增加</@button>
	<@button type="purple" icon="fa fa-pencil" onclick="XJJ.edit('${base}/business/brand/input','修改品牌','${tabId}');">修改</@button>
	<@button type="danger" icon=" fa fa-trash-o" onclick="XJJ.del('${base}/business/brand/delete','删除品牌？',true,{id:'${tabId}'});">删除</@button>
</@content>