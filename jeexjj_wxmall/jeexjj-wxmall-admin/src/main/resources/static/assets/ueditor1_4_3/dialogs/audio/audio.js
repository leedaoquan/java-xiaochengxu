...
(function(){
    ...
    function insertSearch(id){
        ...
        editor.execCommand('insertaudio',videoObjs);
    }
    ...
    function createPreviewVideo(url){
        ...
        var acceptExtensions = (editor.getOpt('audioAllowFiles') || []).join('').replace(/^[,]/, '');;
        var suffix = conUrl.substring(conUrl.lastIndexOf(".")).toLowerCase();
        if(acceptExtensions.indexOf(suffix) > -1){
        	$G("preview").innerHTML = '<div class="previewMsg"><span><audio controls="control" autoplay="autoplay" style="crusor:pointer;"><source src='+conUrl+ ' type="audio/ogg" /></audio></span></div>';
        }else{
    ...
    function insertUpload(){
        ...
        if (count) {
            ...
            editor.execCommand('insertaudio', videoObjs, 'upload');
        }
    }
