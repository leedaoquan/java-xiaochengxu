...
package com.xjj.wxmall.customer.collect.entity;
...
public class CollectEntity extends EntitySupport {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.customer.collect.entity.CollectEntity").append("ID="+this.getId()).toString();
    }
}
