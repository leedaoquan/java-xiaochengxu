...
package com.xjj.wxmall.business.goods.entity;
...
public class GoodsEntity extends EntitySupport {
    ...
    public String getPrimaryPicUrl() {
    	return this.relativePath2Url(primaryPicUrl);
    }
    ...
    public void setPrimaryPicUrl(String primaryPicUrl) {
        this. primaryPicUrl = this.url2RelativePath(primaryPicUrl);
    }
    ...
    public String getListPicUrl() {
        return this.relativePath2Url(listPicUrl);
    }
    ...
    public void setListPicUrl(String listPicUrl) {
       this. listPicUrl = this.url2RelativePath(listPicUrl);
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.business.goods.entity.GoodsEntity").append("ID="+this.getId()).toString();
    }
}
