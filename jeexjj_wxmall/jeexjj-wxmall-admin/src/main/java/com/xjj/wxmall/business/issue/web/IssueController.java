...
**************************************************/
package com.xjj.wxmall.business.issue.web;
import com.xjj.wxmall.business.ad.entity.AdEntity;
import com.xjj.wxmall.business.issue.entity.IssueEntity;
import com.xjj.wxmall.business.issue.service.IssueService;
...
public class IssueController extends SpringControllerSupport{
	...
	private void validateSave(IssueEntity issue){
		//必填项校验
		// 判断shop_id是否为空
		if(null==issue.getShopId()){
			throw new ValidationException("校验失败，shop_id不能为空！");
		}
	}
