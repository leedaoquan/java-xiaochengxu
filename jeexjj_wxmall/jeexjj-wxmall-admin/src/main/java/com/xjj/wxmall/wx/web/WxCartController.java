...
public class WxCartController extends WxBaseController{
    ...
    public Object add(@LoginUser Long userId, @RequestBody CartEntity cart) {
        ...
        System.out.println("goods.getIsOnSale()=="+goods.getIsOnSale());
        if (goods == null || Constants.COMMON_SIMPLE_NO.equals(goods.getIsOnSale())) {
    ...
    public Object checked(@LoginUser Long userId, @RequestBody String body) {
        ...
        Long[] ids = toLongArray(productIds);
    ...
    public Object checkout(@LoginUser Long userId, Long cartId, Long addressId, Long couponId) {
        ...
        System.out.println("cart checkout userId = "+userId);
        System.out.println("cart checkout addressId = "+addressId);
        System.out.println("cart checkout couponId = "+couponId);
        ...
        if(addressId == null || addressId.equals(0L)){
            ...
            System.out.println("==checkedAddress=="+checkedAddress);
            // 如果仍然没有地址，则是没有收获地址
