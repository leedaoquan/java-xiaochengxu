package com.xjj.wxmall.sys.code;
...
public class GCConfig {
	...
	public static void main(String[] args) throws IOException {
		...
		//cfgt.setDirectoryForTemplateLoading(new File("D:/git/gitee/jeexjj_wxmall_init/wxmall-admin/src/main/java/com.xjj.wxmall.sys/code/template")); //如果是maven项目可以使用这种方式
