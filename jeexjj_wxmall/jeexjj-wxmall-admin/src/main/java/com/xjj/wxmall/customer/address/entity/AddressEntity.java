...
package com.xjj.wxmall.customer.address.entity;
...
//    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.customer.address.entity.AddressEntity").append("ID="+this.getId()).toString();
    }
}
