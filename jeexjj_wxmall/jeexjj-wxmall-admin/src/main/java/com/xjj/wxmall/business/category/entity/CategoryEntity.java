...
package com.xjj.wxmall.business.category.entity;
...
public class CategoryEntity extends EntitySupport {
    ...
    public void addSubCategory(CategoryEntity category)
    {
    	...
    	{
    		subCategoryList = new ArrayList<CategoryEntity>();
    	}
	...
	public String getIconUrl() {
		...
		return relativePath2Url(iconUrl);
	}
    ...
    public void setIconUrl(String iconUrl) {
        this.iconUrl = url2RelativePath(iconUrl);
    }
    ...
    public void setImgUrl(String imgUrl) {
        this.imgUrl = url2RelativePath(imgUrl);
    }
	...
	public void setSubCategoryList(List<CategoryEntity> subCategoryList) {
		this.subCategoryList = subCategoryList;
	}
	
	public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.business.category.entity.CategoryEntity").append("ID="+this.getId()).toString();
    }
}
