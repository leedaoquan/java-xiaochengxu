...
package com.xjj.wxmall.business.coupon.entity;
...
public class CouponEntity extends EntitySupport {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.business.coupon.entity.CouponEntity").append("ID="+this.getId()).toString();
    }
}
