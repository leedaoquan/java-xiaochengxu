...
package com.xjj.wxmall.sec.entity;
...
public class RolePrivilegeEntity extends EntitySupport {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.sec.entity.RolePrivilegeEntity").append("ID="+this.getId()).toString();
    }
}
