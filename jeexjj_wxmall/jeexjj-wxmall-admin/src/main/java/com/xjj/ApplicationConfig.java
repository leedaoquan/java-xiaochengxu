...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements CommandLineRunner{
    ...
    public void addInterceptors(InterceptorRegistry registry){
        ...
        regist.excludePathPatterns("/ace/**");
        regist.excludePathPatterns("/assets/**");
        regist.excludePathPatterns("/files/**");
        regist.excludePathPatterns("/style/**");
        regist.excludePathPatterns("/fore/**");
        regist.excludePathPatterns("/wx/**");
