...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="${base}/assets/ueditor1_4_3/ueditor.config.js" ></script>
        <script type="text/javascript" src="${base}/assets/ueditor1_4_3/ueditor.all.js" ></script>
	</head>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">JEEXJJ</span>
