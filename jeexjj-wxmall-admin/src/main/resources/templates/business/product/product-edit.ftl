...
<@input url="${base}/business/product/save" id=tabId>
   ...
   <#list product.goodsSpecificationIds as specs>
   <input  name="specId" type="hidden"  value="${specs}"/>
   </#list>
   ...
   <@formgroup title='商品 '>
   <input readonly="" type="text" class="col-xs-10 col-sm-5" id="form-input-readonly" value="${goods.name}" />
   </@formgroup>
   
   <@formgroup title='规格'>
   <input readonly="" type="text" class="col-xs-10 col-sm-5" id="form-input-readonly" value="${product.goodsSpecificationNames}" />
