...
<@list id=tabId>
	...
	<tbody>
		...
		<tr>
			...
			<td>
            	<@button type="purple" icon="fa fa-pencil" onclick="XJJ.edit('${base}/business/shop/input/${item.id}','修改商家','${tabId}');">修改</@button>
				<@button type="danger" icon=" fa fa-trash-o" onclick="XJJ.del('${base}/business/shop/delete/${item.id}','删除商家？',false,{id:'${tabId}'});">删除</@button>
            </td>
		</tr>
		</#list>
	</tbody>
