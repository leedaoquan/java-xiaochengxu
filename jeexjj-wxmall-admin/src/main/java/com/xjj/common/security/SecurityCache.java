...
import com.xjj.wxmall.sec.service.RolePrivilegeService;
...
public class SecurityCache {
	...
	public static boolean hasPrivilege(freemarker.ext.servlet.HttpRequestHashModel request,String priCode,String function) {
		...
		Object managerObj = request.getRequest().getSession().getAttribute(XJJConstants.SESSION_MANAGER_INFO_KEY);
		...
		if(!(managerObj instanceof ManagerInfo))
		{
			return false;
		}
		
		ManagerInfo manager = (ManagerInfo)managerObj;
