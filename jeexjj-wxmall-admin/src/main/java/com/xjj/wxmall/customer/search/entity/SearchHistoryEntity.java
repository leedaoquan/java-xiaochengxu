...
package com.xjj.wxmall.customer.search.entity;
...
public class SearchHistoryEntity extends EntitySupport {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.customer.search.entity.SearchHistoryEntity").append("ID="+this.getId()).toString();
    }
}
