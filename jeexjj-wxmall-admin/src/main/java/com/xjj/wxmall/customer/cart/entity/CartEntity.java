...
package com.xjj.wxmall.customer.cart.entity;
...
public class CartEntity extends EntitySupport {
    ...
    private Long[] goodsSpecIds;//goods_spec_ids
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.customer.cart.entity.CartEntity").append("ID="+this.getId()).toString();
    }
}
