...
package com.xjj.wxmall.customer.buyer.entity;
...
public class BuyerCouponEntity extends EntitySupport {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.customer.buyer.entity.BuyerCouponEntity").append("ID="+this.getId()).toString();
    }
}
