...
package com.xjj.wxmall.customer.comment.entity;
...
public class CommentEntity extends EntitySupport {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.customer.comment.entity.CommentEntity").append("ID="+this.getId()).toString();
    }
}
