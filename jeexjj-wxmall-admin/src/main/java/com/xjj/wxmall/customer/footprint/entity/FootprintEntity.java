...
package com.xjj.wxmall.customer.footprint.entity;
...
public class FootprintEntity extends EntitySupport {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.customer.footprint.entity.FootprintEntity").append("ID="+this.getId()).toString();
    }
}
