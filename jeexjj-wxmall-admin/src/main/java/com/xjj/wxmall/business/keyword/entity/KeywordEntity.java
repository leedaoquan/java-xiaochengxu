...
package com.xjj.wxmall.business.keyword.entity;
...
public class KeywordEntity extends EntitySupport {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.business.keyword.entity.KeywordEntity").append("ID="+this.getId()).toString();
    }
}
