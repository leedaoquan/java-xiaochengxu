...
package com.xjj.wxmall.business.topic.entity;
...
public class TopicEntity extends EntitySupport {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("com.xjj.wxmall.business.topic.entity.TopicEntity").append("ID="+this.getId()).toString();
    }
}
