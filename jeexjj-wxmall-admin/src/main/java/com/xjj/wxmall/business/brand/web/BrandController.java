...
**************************************************/
package com.xjj.wxmall.business.brand.web;
...
public class BrandController extends SpringControllerSupport{
	...
	public @ResponseBody XjjJson save(@ModelAttribute BrandEntity brand){
		...
		}else
		{
			...
			brandDb.setSortOrder(brand.getSortOrder());
			
			
			brandDb.setAppListPicUrl(brand.getAppListPicUrl());
			brandDb.setListPicUrl(brand.getListPicUrl());
			brandDb.setPicUrl(brand.getPicUrl());
