...
import com.xjj.wxmall.sec.dao.UserDao;
...
//		}
    ...
    private List<XjjUser> validImportUser(Long fileId,Long orgId) throws ValidationException{
		...
		for (int i = 2; i < length; i++) {// 第2行开始
			...
			{
				loginName=StringTools.getRandomString(6)+DateTimeUtils.getCurrentDateTimeString("yyyyMMddHHmmss");
			}
